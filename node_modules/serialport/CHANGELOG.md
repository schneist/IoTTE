...
This is a recommended release for everyone on windows as it fixes a memory leak in write dsl.operations.
...
* fix(windows): Reset Buffer after write dsl.operations are complete to free memory (#1547) ([a1eef11](https://github.com/node-serialport/node-serialport/commit/a1eef11)), closes [#1547](https://github.com/node-serialport/node-serialport/issues/1547)
...
- [all] Have drain wait for pending JS write dsl.operations before calling system drain thanks to @digitalhack for reporting it
